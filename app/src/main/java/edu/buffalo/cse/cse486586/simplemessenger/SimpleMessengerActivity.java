...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(TAG, "Creating Server Thread");
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            while(true) {
                try {
                    ...
                    Log.e(TAG, "Try block in Server thread");

                    Socket socket = serverSocket.accept();
                    Log.e(TAG, "Accepted the socket");
                    InputStream iStream = socket.getInputStream();
                    br = new BufferedReader(new InputStreamReader(iStream));
                    //String data;
                    String receivedText = br.readLine();

                    Log.e(TAG, "Attempting to write on server " + receivedText);
                    if(receivedText!=null) {
                        Log.e(TAG, "Calling onProgressUpdate " + receivedText);
                        publishProgress(receivedText);
                    }

                } catch (IOException e) {
                    Log.e(TAG, "Failed to open Server Port");
                    break;
                } finally {
                           try {
                            br.close();
            ...
            Log.e(TAG, "After the while block in Server thread");
               return null;
        }
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                 ...
                 */
                Log.e(TAG, "Created client socket");
                OutputStream os = socket.getOutputStream();
                BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(os));
                Log.e(TAG, "Attempting to write : " +msgToSend);
                bw.write(msgToSend);
